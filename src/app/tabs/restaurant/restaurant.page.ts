...
export class RestaurantPage implements OnInit {
  ...
  RestaurantOnSale = [
    ...
    },
    {
      ...
      price: '',
      description: 'statues légendaires perchées sur leur pilier central, observent d’un regard amusé l’effervescence de ce Café littéraire de Saint-Germain-des-Prés',
    ...
    },
    {
      ...
      price: '',
      description: 'notre deuxième pêché, s’installe au cœur du 9 ème à deux pas des emblématiques Folies Bergères. Enflammée, démesurée, relevée',
    },
    {
      title: 'New Soul Food',
      img: 'https://th.bing.com/th/id/R.5eb3718e12f39045aec8dbd46bc86df1?rik=E1qkHiMTk8C5YQ&pid=ImgRaw&r=0.jpg',
      price: '',
      description: 'Bienvenue au Maquis, le restaurant de New Soul Food situé dans le 10ème arrondissement à Paris, proche du Canal Saint Martin et du Quai de Jemmapes, de la place Louis Blanc',
    },
    {
      title: 'Bangkok',
      img: 'https://th.bing.com/th/id/OIP.De3COyLmvSPy0oKMhhTRGgHaE8?rs=1&pid=ImgDetMain.jpg',
      price: '',
      description: 'Faites-vous livrer par les meilleurs restaurants de votre quartier. Vos plats préférés de Paris livrés chez vous.',
    }
